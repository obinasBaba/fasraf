      ...
      <div className={s.wrapper}>
        ...
        <div className={s.social}>
          ...
          <Stack gap={1} alignItems="flex-start">
            <Stack>
              ...
              <Typography noWrap color='gray' variant="subtitle1">Sustainable Value</Typography>
            </Stack>
        ...
        <div className={s.contact}>
          ...
          <Stack  gap={2} alignItems='center'>
            ...
            <Button variant="contained" size='large'>+251 92336 5539</Button>
        ...
        <div className={s.pages}>
          ...
          <Stack component="header" gap={1}>
            <Typography gutterBottom variant="h4">Pages</Typography>
