import build from '@/public/assets/lotti/build.json';
import design from '@/public/assets/lotti/design.json';
import prototype from '@/public/assets/lotti/prototype.json';
...
export const services = [
  {
    ...
    description: `We help clients improve their organizational
  ...
  },
  {
    ...
    description: `We help entrepreneurs and ventures to make informed investment
    decision by conducting a comprehensive feasibility study on the intended projects and ideas. We also undertake development of informative concept note on envisaged ideas of our clients.  `,
  },
  {
    icon: align,
    title: 'Strategic Planning',
    description: `We help businesses develop and implement
